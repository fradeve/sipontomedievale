...
call vam#ActivateAddons(["ctags%610", "Tagbar", "tlib", "TaskList", "Better_Javascript_Indentation", "L9", "AutoComplPop", "UltiSnips", "simple-pairs"], {"force_loading_plugins_now": 1})
